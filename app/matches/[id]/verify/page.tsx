      ...
      await runTransaction(db, async (transaction) => {
        ...
        if (isP1NowSubmitted && isP2NowSubmitted) {
          ...
          if (p1Final1 === p2Final1 && p1Final2 === p2Final2) {
            ...
            const p1ProfileRef = doc(db, "player_profiles", data.player1Id);
            const p2ProfileRef = doc(db, "player_profiles", data.player2Id);
            ...
            if (p1Snap.exists() && p2Snap.exists()) {
               ...
               if (p1Final1 > p1Final2) {
                 p1RepChange = 25; p2RepChange = -20;
               } else if (p1Final2 > p1Final1) {
            ...
            if (marketDoc.exists()) {
              let outcome = "draw";
              if (p1Final1 > p1Final2) outcome = "p1";
              else if (p1Final2 > p1Final1) outcome = "p2";
