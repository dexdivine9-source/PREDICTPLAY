  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Add standard platform activities if feed is short
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-10">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-base sm:text-lg font-bold text-white uppercase tracking-wide flex items-center gap-1.5">
            ...
            <Link 
              href="/markets" 
              className="text-xs font-bold text-pp-primary hover:underline flex items-center gap-1 uppercase tracking-wider"
            >
          ...
          {loading ? (
            ...
            <div className="bg-pp-surface/60 border border-pp-border rounded-xl p-5 text-center space-y-2">
              <p className="text-xs text-pp-text-muted">No live matches in progress right now.</p>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <h2 className="text-base sm:text-lg font-bold text-white uppercase tracking-wide flex items-center gap-1.5">
                <Swords className="text-pp-primary" size={18} />
                Upcoming Matches
              </h2>
            </div>
            <Link 
          ...
          {loading ? (
            ...
            <div className="bg-pp-surface/60 border border-pp-border rounded-xl p-5 text-center space-y-3">
              <p className="text-xs text-pp-text-muted">No open challenges waiting at the moment.</p>
              <Link 
                href="/matches/create" 
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-pp-primary text-black font-bold rounded text-xs uppercase tracking-wide hover:bg-pp-primary-dark transition-colors"
              >
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-base sm:text-lg font-bold text-white uppercase tracking-wide flex items-center gap-1.5">
              <Activity className="text-pp-secondary" size={18} />
              Platform Activities
            </h2>
          </div>
